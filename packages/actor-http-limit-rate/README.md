...
* `correctionMultiplier`: How aggressively the delay should follow the latest response time. Defaults to `0.01`.
* `failureMultiplier`: The response time of a failed request is taken into account with this multiplier applied. Defaults to `10`.
